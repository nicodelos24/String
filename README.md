...
3. Al pulsar una tarjeta, el Acompañamiento arranca en ella y esa pulsación cuenta como golpe de ritmo: con dos o más seguidas se estima el tempo, que se ajusta con la música en marcha. Si ya está sonando, el interruptor **Solo pulso** (opción por defecto) deja la música seguir y solo cambia el tempo, mientras que **Reiniciar** vuelve a empezar en la tarjeta pulsada. Con la fuente MIDI o Metrónomo activa no hace nada, y puedes desactivarlo todo con el interruptor **Reproducir desde la tarjeta pulsada** del Acompañamiento. Con secciones, la tarjeta se busca dentro de la lista que se está reproduciendo; si no está en ella, empieza por el principio de esa lista.
