(() => {
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    button.innerHTML='<span class="theme-sky" aria-hidden="true"><span class="theme-symbol-glyph theme-flat">♭</span><span class="theme-symbol-glyph theme-sharp">♯</span></span>';
