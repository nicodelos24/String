(() => {
  ...
  play.addEventListener('click',async()=>{
    ...
    if(!imported || !addCards())return;window.dispatchEvent(new Event('traste:load-song'));play.textContent='Iniciando…';
